...
$(combo_target)GLOBAL_CFLAGS := -fno-exceptions -Wno-multichar -Wno-error=unused-parameter
$(combo_target)RELEASE_CFLAGS := -O2 -g -fno-strict-aliasing -Wno-error=unused-parameter
